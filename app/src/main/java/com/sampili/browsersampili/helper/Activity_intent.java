...
import com.sampili.browsersampili.Activity_Main;
...
public class Activity_intent extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent iMain = new Intent(this, Activity_Main.class);
        iMain.setData(data);
        ...
        if (sharedPref.getBoolean ("openLink", false)){
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                NotificationCompat.Builder builderSummary =
                        new NotificationCompat.Builder(Activity_intent.this)
                                .setAutoCancel(true)
                ...
                Notification notification = new NotificationCompat.Builder(Activity_intent.this)
                        ...
                        .setAutoCancel(true)
                        .setGroup("Browser")
                        .setStyle(new NotificationCompat.BigTextStyle().bigText(data.toString()))
